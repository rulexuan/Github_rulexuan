...
#if 0
	/* 이하의 함수는 매크로로 실현되고 있다(고속화와 컴팩트화를 위해서) */
	/* 인수의 형태등을 알기 쉽게, 함수형 선언을 주석으로서 남겨 있다 */
...
/* function-number */
#define LIB_FN_INIT				0x0004	/* non-malloc형 */
#define LIB_FN_CLOSE			0x0008
#define LIB_FN_WAITSIGNAL		0x0018
#define LIB_FN_WAITSIGNALTIME	0x0018
#define LIB_FN_OPENWINDOW		0x0020	/* non-malloc형 */
#define LIB_FN_OPENWINDOW1		0x0020	/* non-malloc형 */
	/* ↑slot부분에 1을 더하고, flags부분은 256배를 해서 1을 더한다 */
#define LIB_FN_CLOSEWINDOW		0x0024
#define LIB_FN_OPENTEXTBOX		0x0028	/* non-malloc형 */
#define LIB_FN_CLOSETEXTBOX		0x002c
#define LIB_FN_OPENGRAPHBOX		0x0030	/* non-malloc형 */
#define LIB_FN_OPENGRAPHBOX2	0x0030	/* non-malloc형 */
#define LIB_FN_CONTROLWINDOW	0x003c
#define LIB_FN_PUTSTRING		0x0040
	/* ↑보통으로 사용한다면 opt에 0x4000를 더한다 */
	/* ↑텍스트로 한다면 0x4000을 더하지 않는다 */
#define LIB_FN_DRAWLINE			0x0044
#define LIB_FN_FLUSHGRAPHBOX	0x004c	/* 뒷부분에 0x000c를 추가 */
#define LIB_FN_PUTBLOCK1		0x004c	/* 선두에 opt로서 1을 추가, 게다가 뒷부분에 0x000c를 추가 */
#define LIB_FN_DRAWPOINTS1		0x0050	/* 뒷부분에 0x000c를 추가 */
#define LIB_FN_DRAWLINE0		0x0054
#define LIB_FN_DRAWPOINT0		0x0054
	/* ↑x와 y뒤에, 또 x, y를 추가：실은 DRAWLINE0으로 속이기 위해서 */
#define LIB_FN_PUTBLOCK02001	0x0058	/* 선두에 opt로서 0x2001를 추가 */
#define LIB_FN_PUTBLOCK03001	0x0058	/* 선두에 opt로서 0x3001를 추가 */
#define LIB_FN_DRAWPOINTS0		0x005c	/* 뒷부분에 0x000c를 추가 */
#define LIB_FN_OPENSIGNALBOX	0x0060	/* non-malloc형 */
#define LIB_FN_DEFINESIGNAL		0x0068
	/* ↑0p0의 경우는, 뒷부분에 0을 2개 추가 */
	/* ↑1p0의 경우는, signal 전에 1을 추가, signal 뒤에 0을 추가 */
...
#define LIB_FN_MAPMODULE		0x00c0	/* addr 뒤에 0x000c를 추가, ofs와 attr는 더해서 1개로 */
#define LIB_FN_UNMAPMODULE		0x00c4	/* addr 뒤에 0x000c를 추가 */
#define LIB_FN_LOADFONTSET		0x00e0	/* 뒷부분에 0x000c를 추가 */
#define LIB_FN_LOADFONTSET0		0x00e0
#define LIB_FN_MAKECHARSET		0x00e8
#define LIB_FN_WSJIS2GG00JPN0	0x00ec
	/* ↑선두에 opt로써 1을 추가, sjis와 gg00jpn의 뒤에 각각 0x000c를 추가 */
#define LIB_FN_SEUC2GG00		0x00ec
	/* ↑선두에 opt로써 2를 추가, seuc와 gg00의 뒤에 각각 0x000c를 추가 */
#define LIB_FN_DRAWLINES0		0x0108	/* 뒷부분에 0x000c를 추가 */
#define LIB_FN_CONVLINES		0x010c	/* 뒷부분에 0x000c를 추가 */
#define LIB_FN_DRAWLINES1		0x0110	/* 뒷부분에 0x000c를 추가 */
#define LIB_FN_RESIZEMODULE		0x0120	/* sig 전에 1을 추가 */
#endif
